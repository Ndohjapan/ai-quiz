...
exports.up = pgm => {
    ...
    pgm.sql(`
        CREATE OR REPLACE FUNCTION update_quiz_result_by_id(id INTEGER, json_data json)
        RETURNS void AS $$
        DECLARE
            update_query text;
            field text;
            json_value text;
        BEGIN
            update_query := 'UPDATE quiz_result SET ';
...
exports.down = pgm => {
    pgm.sql(`
        DROP FUNCTION update_quiz_result_by_id(INTEGER, JSON);
    `)
};
